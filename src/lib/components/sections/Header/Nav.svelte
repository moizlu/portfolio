...
<nav class="p-4 pr-0 relative isolate w-full md:w-170 lg:w-200">
    ...
    <!-- 背景を透明にすると白いのが見える -->
    <ul bind:this={activeOverlayElement} class="absolute active-overlay-ul w-full top-0 left-0 m-4 pr-4 pointer-events-none flex-center gap-1 sm:gap-4 bg-base/1">
        {#each sectionItems as section}
